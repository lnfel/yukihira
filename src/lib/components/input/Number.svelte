...
<div class="flex items-stretch">
    ...
    <input bind:value type="number" class="number-input focus:isolate w-12 appearance-none bg-saddle-100 text-saddle-800 text-center outline-none ring-2 ring-transparent ring-offset-2 ring-offset-transparent focus:ring-offset-saddle-900 focus:ring-saddle-500 focus:border-saddle-500" min="0">
